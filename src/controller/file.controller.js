const {wordCount, characterCount, sentenceCount, paragraphCount, largestWordsinParagraphs} = require("../service/text.service")
...
const countWords = async (req,res) => {
    ...
    try {
        const response = fileId ? await wordCount(fileId,userId) : await wordCount();
